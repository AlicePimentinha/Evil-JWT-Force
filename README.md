...
### Windows
1. Execute o instalador ou rode diretamente python main.py .
2. Utilize o atalho criado ou scripts .bat para inicialização rápida.
## Uso
...
Desenvolvido para fins educacionais e de pesquisa em segurança. O uso indevido é de responsabilidade do usuário.